...
# Membuat daftar data ikan dan alat tangkap
data = [
...
selected_gear = st.selectbox("Pilih Alat Tangkap:", ["Semua Alat Tangkap", "Rawai Tuna", "Jaring Insang Hanyut", "Pukat Cincin Pelagis", "Bubu", "Bouke Ami", "Pancing Ulur", "Bagan Berperahu"])
...
st.markdown("""
    <div id="cluster-info" class="cluster-info">
        ...
        <p><strong>Cluster 0:</strong> Ikan-ikan dalam cluster ini cenderung memiliki nilai dan volume produksi yang lebih rendah...</p>
        <p><strong>Cluster 1:</strong> Cluster ini terdiri dari ikan-ikan yang lebih bernilai komersial...</p>
        <p><strong>Cluster 2:</strong> Ikan-ikan dalam cluster ini adalah yang paling bernilai...</p>
    </div>
""", unsafe_allow_html=True)
